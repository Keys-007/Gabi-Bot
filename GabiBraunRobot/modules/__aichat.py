...
from GabiBraunRobot.helper_extra.aichat import add_chat, get_session, remove_chat
from GabiBraunRobot.pyrogramee.pluginshelper import admins_only, edit_or_reply
from GabiBraunRobot import pgram as gabi
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("gabi", "Aco")
        URL = "https://api.affiliateplus.xyz/api/chatbot?message=hi&botname=@GabiBraun&ownername=@The_Ghost_Hunter"
